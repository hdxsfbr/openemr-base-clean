...
final class Bootstrap
{
    ...
    private function panelHtml(): string
    {
        ...
        return '<link rel="stylesheet" href="' . attr($assets . '/css/copilot.css?v=' . $version) . '">'
            ...
            . '</div></details>'
            . '<details class="copilot-review" id="copilot-review">'
            . '<summary>' . xlt('Review extracted document') . '</summary>'
            . '<div id="copilot-review-status" class="small text-muted" role="status" aria-live="polite">'
            . xlt('No extraction has been read yet.') . '</div>'
