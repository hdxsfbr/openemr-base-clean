...
**Current status (2026-09-18).** Latest tracked full run: `evals/results/2026-09-18T210912Z-61ed997.md` (46 cases, 46 passed, every blocking gate PASS, citations 188/188 resolved, model-backed p95 18.0 s, $0.0103 per model-backed turn) — after amending `max_plan_rounds` 3 -> 1 the same day (`docs/audit/evidence/performance/model-experiments-2026-09-18.md`). Kept as history, not as the current number: the immediately-prior `rounds=3` baseline `evals/results/2026-09-18T201618Z-1fda51b.md` (45/46, p95 27.5 s, `$0.0133/turn`), `evals/results/2026-09-17T024919Z-a4a5856.md` (45 cases, 44 passed, Golden set integrity 14/14 for the first time, citations 177/177, p95 24.1 s, $0.0127/turn), the same-commit `--repeat 3` report `evals/results/2026-09-16T073141Z-1ddf824.md` (44 cases x 3 attempts, 114/116 passed, citations 528/528), and the single run `evals/results/2026-09-16T081636Z-69560f05.md` (43/44, committed in `413c788`). The one recurring miss across all of these is `MISS-AUTHOR-J-001`, a non-deterministic model-recall check under the non-blocking task-success gate (failed at `1ddf824` attempts 1 and 3, at `69560f05`, at `a4a5856`, and at `2026-09-18T201618Z-1fda51b`; passed at `61ed997`) — every deterministic line has passed in every one of these runs.
