...
| Guideline retrieval latency | p95 at or below 1.5 s under a 2 s hard deadline | Evidence must still fit the pre-visit workflow. Report keyword, dense, fusion, rerank, and total stages; returning fewer candidates or skipping rerank cannot make a run green. |
