...
def build_graph(rt: Runtime, checkpointer=None):
    ...
    g.add_conditional_edges("narrate", by_route("verify", "render"), {"verify": "verify", "render": "render"})
    g.add_conditional_edges("verify", by_route("repair", "render"), {"repair": "repair", "render": "render"})
    g.add_conditional_edges("repair", by_route("verify", "render"), {"verify": "verify", "render": "render"})
