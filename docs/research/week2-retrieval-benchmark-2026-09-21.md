...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| SQLite FTS5 sparse | 1.000 | 0.844 | 0.742 | 0.750 | 0.16 ms | 0.21 ms |
| TF-IDF/SVD FAISS control | 1.000 | 0.918 | 0.841 | 0.875 | 0.32 ms | 0.36 ms |
| BGE-small exact FAISS | 1.000 | 1.000 | 0.983 | 1.000 | 6.14 ms | 7.37 ms |
| Sparse + BGE RRF | 1.000 | 1.000 | 0.932 | 1.000 | 6.28 ms | 7.37 ms |
| RRF + lexical rerank control | 1.000 | 0.910 | 0.815 | 0.833 | 6.59 ms | 7.61 ms |
| RRF + ONNX cross-encoder | 1.000 | 1.000 | 0.963 | 1.000 | 177.7 ms | 314.1 ms |
...
- Corpus/index build: 7.32 s wall, 17.70 CPU-s; the two-thread limit consumed
  about 2.42 cores during build.
- Cold model session load: 138 ms BGE and 46 ms reranker; first rerank 163 ms.
- Peak process RSS: 505,634,816 bytes (482 MiB), including Python and all
  libraries/models; incremental BGE session RSS was about 178 MiB.
- Model files: 126.9 MiB BGE and 22.1 MiB reranker.
- Indexes: 240 KiB BGE FAISS, 248 KiB SQLite sparse, and 40 KiB control FAISS.
- One-worker p95: sparse 0.37 ms, BGE dense 7.63 ms.
- Ten-worker p95: sparse 3.73 ms, BGE dense 23.19 ms.
