...
| Guideline evidence through hybrid RAG | Slice 3A/#40 implements the offline approved USPSTF corpus manifest, deterministic heading-aware chunks, identical-set FTS5/FAISS artifacts, active pointer, pinned BGE model/tokenizer/runtime hashes, and strict `EvidenceQuery`/guideline source-citation-claim exports. Slice 3B/#41 adds the local FTS5/BGE/RRF/MiniLM engine with hash-bound setup-time model provisioning, exact excerpts, and fail-closed retrieval (`docs/week2/slice3b-guideline-retrieval.md`). Slice 3C/#42 adds the strict local worker envelope, atomic terminal limitation behavior, cancellation/stale/duplicate handoff controls, and PHI-free correlated worker telemetry (`docs/week2/slice3c-evidence-retriever-worker.md`). It does not add supervisor routing, resolver, verifier, UI, authorization route, or deployment; those remain later slices. The "no general medical knowledge" refusal remains the Week 1 as-built scope. |
