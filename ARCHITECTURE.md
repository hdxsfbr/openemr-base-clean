...
| Lab PDF and intake-form ingestion; round-tripping derived records without duplicates | Slice 1A/1B now provides only the synthetic lab-PDF upload and deterministic, review-only cited preview (`docs/week2/slice1a-upload-contract.md`, `docs/week2/slice1b-extraction-preview.md`). Intake, review/promotion, overlay, and round-trip records remain Week 2 work under ADR-0008, ADR-0009, ADR-0011, and ADR-0012. |
