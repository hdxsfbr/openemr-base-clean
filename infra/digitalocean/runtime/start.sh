...
for secret_name in anthropic_api_key anthropic_workspace_id langfuse_public_key langfuse_secret_key slack_alert_webhook openrouter_api_key; do
...
chmod 644 secrets/anthropic_api_key secrets/anthropic_workspace_id secrets/copilot_delegation_secret secrets/langfuse_public_key secrets/langfuse_secret_key secrets/slack_alert_webhook secrets/openrouter_api_key
chmod 700 secrets
